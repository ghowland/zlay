...
pub const SLOT_COUNT: usize = 5000;
pub const TEXT_LEN_MAX: usize = 1500;
pub const HASH_BUCKET_COUNT: usize = 5000;
pub const TREE_ROOT_COUNT: usize = 5000;
pub const WRAPPED_LINE_COUNT: usize = 5000;
pub const TEXT_DATA_COUNT: usize = 5000;
pub const RENDER_CMD_COUNT: usize = 10000;
pub const POINTER_OVER_COUNT: usize = 64;

// --- Sizing type pub constants (i32 enums) ---
pub const SIZE_FIT: i32 = 0;
pub const SIZE_GROW: i32 = 1;
pub const SIZE_PERCENT: i32 = 2;
pub const SIZE_FIXED: i32 = 3;

// --- Layout direction pub constants ---
pub const LAYOUT_LEFT_TO_RIGHT: i32 = 0;
pub const LAYOUT_TOP_TO_BOTTOM: i32 = 1;

// --- Slot state pub constants ---
pub const STATE_EMPTY: i32 = 0;
pub const STATE_LIVE: i32 = 1;
pub const STATE_DEAD: i32 = 2;

// --- Render command type pub constants ---
pub const CMD_SCISSOR_START: i32 = 0;
pub const CMD_RECTANGLE: i32 = 1;
pub const CMD_IMAGE: i32 = 2;
pub const CMD_TEXT: i32 = 3;
pub const CMD_CUSTOM: i32 = 4;
pub const CMD_BORDER: i32 = 5;
pub const CMD_SCISSOR_END: i32 = 6;

// --- Pointer state pub constants ---
pub const PTR_RELEASED: i32 = 0;
pub const PTR_PRESSED_THIS_FRAME: i32 = 1;
pub const PTR_PRESSED: i32 = 2;
pub const PTR_RELEASED_THIS_FRAME: i32 = 3;
...
pub var ring_buffer: [SLOT_COUNT]Slot = [_]Slot{Slot{}} ** SLOT_COUNT;
pub var layout_configs: [SLOT_COUNT]LayoutConfig = [_]LayoutConfig{LayoutConfig{}} ** SLOT_COUNT;
pub var shared_configs: [SLOT_COUNT]SharedConfig = [_]SharedConfig{SharedConfig{}} ** SLOT_COUNT;
pub var border_configs: [SLOT_COUNT]BorderConfig = [_]BorderConfig{BorderConfig{}} ** SLOT_COUNT;
pub var floating_configs: [SLOT_COUNT]FloatingConfig = [_]FloatingConfig{FloatingConfig{}} ** SLOT_COUNT;
pub var clip_configs: [SLOT_COUNT]ClipConfig = [_]ClipConfig{ClipConfig{}} ** SLOT_COUNT;
pub var text_configs: [SLOT_COUNT]TextConfig = [_]TextConfig{TextConfig{}} ** SLOT_COUNT;
pub var aspect_configs: [SLOT_COUNT]f32 = [_]f32{0.0} ** SLOT_COUNT;
pub var image_configs: [SLOT_COUNT]i32 = [_]i32{-1} ** SLOT_COUNT;
pub var custom_configs: [SLOT_COUNT]i32 = [_]i32{-1} ** SLOT_COUNT;
pub var text_data: [TEXT_DATA_COUNT]TextElementData = [_]TextElementData{TextElementData{}} ** TEXT_DATA_COUNT;
pub var wrapped_lines: [WRAPPED_LINE_COUNT]WrappedLine = [_]WrappedLine{WrappedLine{}} ** WRAPPED_LINE_COUNT;
pub var tree_roots: [TREE_ROOT_COUNT]TreeRoot = [_]TreeRoot{TreeRoot{}} ** TREE_ROOT_COUNT;
pub var hash_buckets: [HASH_BUCKET_COUNT]i32 = [_]i32{-1} ** HASH_BUCKET_COUNT;
pub var render_commands: [RENDER_CMD_COUNT]RenderCommand = [_]RenderCommand{RenderCommand{}} ** RENDER_CMD_COUNT;
pub var pointer_over_ids: [POINTER_OVER_COUNT]i32 = [_]i32{-1} ** POINTER_OVER_COUNT;

// Counters for next-free-slot in each array
pub var next_slot: i32 = 0;
pub var next_layout_config: i32 = 0;
pub var next_shared_config: i32 = 0;
pub var next_border_config: i32 = 0;
pub var next_floating_config: i32 = 0;
pub var next_clip_config: i32 = 0;
pub var next_text_config: i32 = 0;
pub var next_aspect_config: i32 = 0;
pub var next_text_data: i32 = 0;
pub var next_wrapped_line: i32 = 0;
pub var next_tree_root: i32 = 0;
pub var next_render_cmd: i32 = 0;

pub var current_generation: i32 = 1;
pub var layout_width: f32 = 800.0;
pub var layout_height: f32 = 600.0;

// Declaration stack
pub var decl_stack: [256]i32 = [_]i32{-1} ** 256;
pub var decl_stack_top: i32 = -1;

// Pointer state
pub var pointer_state: i32 = PTR_RELEASED;
pub var pointer_over_write_head: i32 = 0;
...
pub const BIT_DECLARATION: i32 = 1 << 1;
pub const BIT_SIZE_X: i32 = 1 << 2;
pub const BIT_TEXT_WRAP: i32 = 1 << 3;
pub const BIT_ASPECT_RATIO_V: i32 = 1 << 4;
pub const BIT_PROPAGATE_HEIGHTS: i32 = 1 << 5;
pub const BIT_SIZE_Y: i32 = 1 << 6;
pub const BIT_ASPECT_RATIO_H: i32 = 1 << 7;
pub const BIT_SORT_Z: i32 = 1 << 8;
pub const BIT_FINAL_LAYOUT: i32 = 1 << 9;
pub const BIT_POINTER_DETECTION: i32 = 1 << 0;

pub var passes_completed: i32 = 0;
...
// --- PASS 1: declaration ---
// This is the test harness element tree. The declaration IS the
...
fn nextSibling(slot_idx: i32) i32 {
    const end = ring_buffer[@intCast(slot_idx)].children_end;
    if (end > slot_idx + 1) {
        std.debug.print("    Next Sibling: Returning end: {}\n", .{end});
        return end;
    }
    const next = slot_idx + 1;

    std.debug.print("    Next Sibling: {}\n", .{next});
